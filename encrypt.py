...
h = cv2.imread(image_path)

# Check if the image was loaded successfully
if h is None:
    raise ValueError(f"Failed to load image at {image_path}. Please check the file path and ensure the file exists and is a valid image.")

# If the image was loaded successfully, proceed with the rest of your code
i = h.shape[0]
